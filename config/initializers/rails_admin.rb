...
RailsAdmin.config do |config|
  ...
  #     configure :banner_file_name, :string         # Hidden 
  #     configure :banner_content_type, :string         # Hidden 
  #     configure :banner_file_size, :integer         # Hidden 
  #     configure :banner_updated_at, :datetime         # Hidden 
  #     configure :banner, :paperclip 
  #     configure :created_at, :datetime 
  #     configure :updated_at, :datetime 
  ...
  #     configure :parent_catalog, :belongs_to_association 
  ...
  #     configure :catalog, :belongs_to_association 
  #     configure :child_catalogs, :has_many_association 
  ...
  #     configure :child_catalog, :belongs_to_association 
  ...
  #     configure :description, :string 
  #     configure :sponsor_file_name, :string         # Hidden 
  #     configure :sponsor_content_type, :string         # Hidden 
  #     configure :sponsor_file_size, :integer         # Hidden 
  #     configure :sponsor_updated_at, :datetime         # Hidden 
  #     configure :sponsor, :paperclip 
  #     configure :created_at, :datetime 
  #     configure :updated_at, :datetime 
